        ...
        <?php
          if($_POST)
          {
            if(!empty($_POST["baslik"]) && !empty($_POST["anahtar"]) && !empty($_POST["description"]))
            {
              ...
              {
                $guncelle=$vt->SorguCalistir("UPDATE ayarlar".$kontrol[0]["tablo"],"SET baslik=?,anahtar=?, aciklama=? WHERE id=? ",array($baslik,$anahtar,$description,1),1);
          ...
          <div class="card-body card card-primary ">
            ...
            <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="BAŞLIK ..." name="baslik" value="<?=$sitebaslik?>">
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-group">
